...
class AppConstants {
  static const List<String> algerianWilayas = [
    ...
    '59- آفلو', '60- بريكة', '61- القنطرة', '62- بئر العاتر', '63- العريشة', '64- قصر الشلالة',
  ...
  static const Map<String, Map<String, String>> localizedTexts = {
    'ar': {
      'nav_register': 'تسجيل جمعية',
      'nav_upload': 'رفع حالة',
      'nav_wall': 'جدار الأمل',
      'title': 'بوابة التكافل الشاملة',
      'subtitle': 'خدمات تضامنية مدمجة ومنظمة جغرافياً',
      'filter_all': 'الكل',
      'filter_medical': 'طبية وجنائز',
      'filter_economic': 'تمكين ومساعدات',
      'filter_mosque': 'إعمار ومطاعم رحمة',
      'filter_fatwa': 'فتاوى واستشارات',
      'filter_protection': 'حالات خاصة',
      'location_lbl': 'الولاية:',
      'reg_title': 'إنشاء حساب جمعية جديد',
      'upload_title': 'إنشاء طلب مساعدة أو نداء جديد',
    }
  };
}